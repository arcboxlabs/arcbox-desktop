...
private final class LocalFileNode: NSObject {
...
final class LocalRootFSOutlineCoordinator: NSObject, NSOutlineViewDataSource, NSOutlineViewDelegate {
    private var parent: LocalRootFSOutlineView
    private typealias FileSystemService = LocalRootFSService
    private var rootNodes: [LocalFileNode] = []
    ...
    private func loadChildrenIfNeeded(for node: LocalFileNode) {
    ...
    private func selectedNode() -> LocalFileNode? {
    ...
    private func toggleExpandOrCollapse(_ node: LocalFileNode) {
    ...
    private func open(_ node: LocalFileNode) {
    ...
    private func nameCell(for node: LocalFileNode, outlineView: NSOutlineView) -> NSView {
