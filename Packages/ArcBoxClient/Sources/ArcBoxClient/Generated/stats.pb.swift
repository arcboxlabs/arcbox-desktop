...
public struct Arcbox_V1_StatsWatchRequest: Sendable {
...
extension Arcbox_V1_StatsWatchRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".StatsWatchRequest"
  ...
  public static func ==(lhs: Arcbox_V1_StatsWatchRequest, rhs: Arcbox_V1_StatsWatchRequest) -> Bool {
