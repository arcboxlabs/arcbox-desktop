...
public struct Sandbox_V1_ReadFileRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Sandbox_V1_FileChunk: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Sandbox_V1_WriteFileOpen: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Sandbox_V1_WriteFileRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var payload: Sandbox_V1_WriteFileRequest.OneOf_Payload? = nil

  /// Stream header — sandbox, path, and mode.
  public var `open`: Sandbox_V1_WriteFileOpen {
    get {
      if case .open(let v)? = payload {return v}
      return Sandbox_V1_WriteFileOpen()
    }
    set {payload = .open(newValue)}
  }

  /// File content chunk; the last one has done == true.
  public var chunk: Sandbox_V1_FileChunk {
    get {
      if case .chunk(let v)? = payload {return v}
      return Sandbox_V1_FileChunk()
    }
  ...
  public enum OneOf_Payload: Equatable, Sendable {
    /// Stream header — sandbox, path, and mode.
    case `open`(Sandbox_V1_WriteFileOpen)
    /// File content chunk; the last one has done == true.
    case chunk(Sandbox_V1_FileChunk)
...
public struct Sandbox_V1_ExposePortRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Sandbox_V1_ExposePortResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Sandbox_V1_UnexposePortRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Sandbox_V1_SandboxPortForwardRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Sandbox_V1_SandboxPortForwardResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Sandbox_V1_SandboxPortForwardRemoveRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Sandbox_V1_ReadFileRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Sandbox_V1_ReadFileRequest, rhs: Sandbox_V1_ReadFileRequest) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Sandbox_V1_FileChunk: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Sandbox_V1_FileChunk, rhs: Sandbox_V1_FileChunk) -> Bool {
    if lhs.data != rhs.data {return false}
    if lhs.done != rhs.done {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Sandbox_V1_WriteFileOpen: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Sandbox_V1_WriteFileOpen, rhs: Sandbox_V1_WriteFileOpen) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.path != rhs.path {return false}
    if lhs.mode != rhs.mode {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Sandbox_V1_WriteFileRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Sandbox_V1_WriteFileOpen?
        var hadOneofValue = false
        if let current = self.payload {
          hadOneofValue = true
  ...
  public static func ==(lhs: Sandbox_V1_WriteFileRequest, rhs: Sandbox_V1_WriteFileRequest) -> Bool {
    if lhs.payload != rhs.payload {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Sandbox_V1_ExposePortRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Sandbox_V1_ExposePortRequest, rhs: Sandbox_V1_ExposePortRequest) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Sandbox_V1_ExposePortResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Sandbox_V1_ExposePortResponse, rhs: Sandbox_V1_ExposePortResponse) -> Bool {
    if lhs.hostPort != rhs.hostPort {return false}
...
extension Sandbox_V1_UnexposePortRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Sandbox_V1_UnexposePortRequest, rhs: Sandbox_V1_UnexposePortRequest) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.sandboxPort != rhs.sandboxPort {return false}
    if lhs.`protocol` != rhs.`protocol` {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Sandbox_V1_SandboxPortForwardRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Sandbox_V1_SandboxPortForwardRequest, rhs: Sandbox_V1_SandboxPortForwardRequest) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.sandboxPort != rhs.sandboxPort {return false}
    if lhs.`protocol` != rhs.`protocol` {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Sandbox_V1_SandboxPortForwardResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Sandbox_V1_SandboxPortForwardResponse, rhs: Sandbox_V1_SandboxPortForwardResponse) -> Bool {
    if lhs.guestPort != rhs.guestPort {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Sandbox_V1_SandboxPortForwardRemoveRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Sandbox_V1_SandboxPortForwardRemoveRequest, rhs: Sandbox_V1_SandboxPortForwardRemoveRequest) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.sandboxPort != rhs.sandboxPort {return false}
    if lhs.`protocol` != rhs.`protocol` {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
